...
Authors: David Fisher and Yiyuan bob wang.
...
def main():
    ...
    my_name = "Bob"  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = "Heda"  # Used to set the topic that you will *publish to*
